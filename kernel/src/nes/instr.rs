        ...
        if code.len() == 0 {
            ...
            match code[0] {
                ...
                0x01 => Instruction {
                    ...
                    addr_mode: AddrMode::IndirectX(code[1]),
                },
                0x05 => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::ZeroPage(code[1]),
                },
                0x06 => Instruction {
                ...
                0x09 => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::Immediate(code[1]),
                },
                0x0A => Instruction {
                    instr_type: InstrType::ASL,
                    addr_mode: AddrMode::Implied,
                ...
                0x0D => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::Absolute(u16::from_le_bytes([code[1], code[2]])),
                },
                0x0E => Instruction {
                    instr_type: InstrType::ASL,
                    addr_mode: AddrMode::Absolute(u16::from_le_bytes([code[1], code[2]])),
                ...
                0x10 => Instruction {
                    ...
                    addr_mode: AddrMode::Relative(code[1] as i8),
                },
                0x11 => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::IndirectY(code[1]),
                },
                0x15 => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::ZeroPageX(code[1]),
                },
                0x16 => Instruction {
                    instr_type: InstrType::ASL,
                    addr_mode: AddrMode::ZeroPageX(code[1]),
                ...
                0x19 => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::AbsoluteY(u16::from_le_bytes([code[1], code[2]])),
                },
                0x1D => Instruction {
                    instr_type: InstrType::ORA,
                    addr_mode: AddrMode::AbsoluteX(u16::from_le_bytes([code[1], code[2]])),
                },
                0x1E => Instruction {
                    instr_type: InstrType::ASL,
                    addr_mode: AddrMode::AbsoluteX(u16::from_le_bytes([code[1], code[2]])),
                ...
                0x6C => Instruction {
                    instr_type: InstrType::JMP,
                    addr_mode: AddrMode::Indirect(u16::from_le_bytes([code[1], code[2]])),
                },
                0x6D => Instruction {
                    instr_type: InstrType::ADC,
                    addr_mode: AddrMode::Absolute(u16::from_le_bytes([code[1], code[2]])),
                ...
                0x96 => Instruction {
                    instr_type: InstrType::STX,
                    addr_mode: AddrMode::ZeroPageY(code[1]),
                },
                0x98 => Instruction {
